    ...
    roles: {
      'MELT DPS': {
        ...
        artifacts: [
          ['shimenawas_reminiscence'],
          ['wanderers_troupe'],
          ['blizzard_strayer', '+18%_atk_set', '+80_em'],
        ],
        mainStats: {
          sands: ['EM', 'ATK%'],
          goblet: ['Cryo DMG'],
    ...
    roles: {
      SUPPORT: {
        ...
        artifacts: [
          ['viridescent_venerer'],
          ['noblesse_oblige'],
          ['emblem_of_severed_fate', '+15%_healing_bonus_set'],
        ],
        mainStats: {
          sands: ['Energy Recharge', 'Elemental Mastery'],
  ...
  shikanoin_heizou: {
    roles: {
      'ANEMO DPS': {
        ...
        artifacts: [
          ['viridescent_venerer'],
          ['viridescent_venerer', '+18%_atk_set', '+80_em'],
        ],
        mainStats: {
          sands: ['ATK%'],
          goblet: ['Anemo DMG'],
  ...
  traveler_anemo: {
    roles: {
      'ANEMO DPS': {
        ...
        artifacts: [
          ['viridescent_venerer'],
          ['viridescent_venerer', '+80_em', 'noblesse_oblige', '+18%_atk_set'],
        ],
        mainStats: {
  ...
  noelle: {
    roles: {
      ...
      SUPPORT: {
        ...
        artifacts: [
          ['husk_of_opulent_dreams'],
          ['husk_of_opulent_dreams', '+15%_healing_bonus_set'],
        ],
        mainStats: {
          sands: ['DEF%'],
          goblet: ['DEF%'],
