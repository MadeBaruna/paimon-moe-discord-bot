  ...
  yanfei: {
    roles: {
      ...
      'SHIELD SUPPORT': {
        ...
        note: '[NEED C4+] This section is dedicated to a playstyle where Yanfei is utilised as a primary shielder through her 4th Constellation. Due to the requirement of having to burst off cooldown, this build has high energy requirements.',
      },
    },
  },
  thoma: {
  ...
  traveler_geo: {
    roles: {
      'GEO DPS': {
        ...
        note: "This section is dedicated to utilising the Geo Traveler's Geo Elemental Burst damage capabilities. Due to how little field time this playstyle takes, the Traveler can also fulfill the role of a quickswap style Sub-DPS.\n\nRegarding Weapon Choices: \nFestering Desire, Skyward Blade, Amenoma Kageuchi: These weapons help in bursting off cooldown, but if you're not having issues with energy, then these weapons falls behind in terms of damage.",
      },
      'PHYSICAL DPS': {
        recommended: false,
        weapons: [
