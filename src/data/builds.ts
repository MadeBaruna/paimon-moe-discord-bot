  ...
  yanfei: {
    roles: {
      ...
      'SHIELD SUPPORT': {
        ...
        subStats: [' Energy Recharge', ' HP% ', ' Flat HP'],
        talent: [
          'Talent provide nothing for this role and it is not recommended to level them.',
        ],
  ...
  fischl: {
    roles: {
      ...
      'OFF-FIELD DPS': {
        ...
        talent: [' Skill', ' Burst'],
        tip: 'See  https://bit.ly/3xOMZyh  for more specifics regarding the weapon rankings.  Courtesy of itsjaeYOU#2868',
