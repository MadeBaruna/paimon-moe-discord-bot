  ...
  yanfei: {
    roles: {
      ...
      'SHIELD SUPPORT': {
        ...
        note: "<b></b>[C4+ REQUIRED] This section is dedicated to a playstyle where Yanfei is utilised as a primary shielder through her 4th Constellation. Due to the requirement of having to burst off cooldown, this build has <b>high energy requirements.\n</b>\n\nYanfei's talent levels provide nothing for this role and it is not recommended to level them.",
      },
    },
  },
  thoma: {
  ...
  shenhe: {
    roles: {
      SUPPORT: {
        ...
        artifacts: [
          ['noblesse_oblige'],
          ['+18%_atk_set', '+18%_atk_set', 'emblem_of_severed_fate'],
        ],
        mainStats: {
          sands: ['ATK%', 'Energy Recharge'],
          goblet: ['ATK%'],
