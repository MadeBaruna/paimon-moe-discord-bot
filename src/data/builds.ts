  ...
  traveler_electro: {
    roles: {
      SUPPORT: {
        ...
        artifacts: [
          ['noblesse_oblige'],
          ['emblem_of_severed_fate', 'the_exile', 'scholar'],
        ],
        mainStats: {
  ...
  traveler_geo: {
    roles: {
      'GEO DPS': {
        ...
        note: "This section is dedicated to utilising the Geo Traveller's Geo Elemental Burst damage capabilities. Due to how little field time this playstyle takes, the traveller can also fulfill the role of a quickswap style Sub-DPS.\nRegarding Weapon Choices: Festering Desire, Skyward Blade, Amenoma Kageuchi: These weapons help in bursting off cooldown, but if you're not having issues with energy, then these weapons falls behind in terms of damage.",
      },
      'PHYSICAL DPS': {
        recommended: false,
        weapons: [
