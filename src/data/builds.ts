  ...
  ganyu: {
    roles: {
      'Melt DPS': {
        ...
        talent: ['Normal Attack', 'Skill', 'Burst'],
        tip: '',
        note: "Ganyu's lv.2 Charged Shot applies two instances Cryo as they do not share the same ICD, which allows you to trigger Melt reaction twice for both damage instances. For her Melt DPS, Charged Attack will be the majority of her damage output while neglecting her Skill/Burst damage contribution for most scenarios.\n\nRegarding Hamayumi: This weapon doesn't synergize well with Shimenawa's Reminiscence (4) due to its passive. Generally just use Prototype Crescent over this weapon.",
      },
      'Freeze DPS': {
        recommended: true,
        weapons: [
